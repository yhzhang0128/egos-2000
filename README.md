...
```shell
> cloc egos-riscv --exclude-ext=md  # Exclude the Markdown documents
      53 text files.
      53 unique files.                              
       7 files ignored.

github.com/AlDanial/cloc v 1.82  T=0.03 s (1767.1 files/s, 135987.8 lines/s)
-------------------------------------------------------------------------------
Language                     files          blank        comment           code
-------------------------------------------------------------------------------
C                               27            508            387           1957
C/C++ Header                    16             99            102            406
Assembly                         3              3             21             69
make                             1             12              0             53
-------------------------------------------------------------------------------
SUM:                            47            622            510           2485
