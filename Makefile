...
QEMU_FLAGS  = -M virt -smp 4 -m 8M -bios tools/egos.bin -device sdhci-pci,addr=0x1 -drive if=none,file=tools/disk.img,format=raw,id=MMC -device sd-card,drive=MMC
