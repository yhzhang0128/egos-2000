...
char* contents[] = {
                    ...
                    ".   2 ..   1 README   4 ",
                    ".   3 ..   1 ",
                    "With only **2K** lines of code, egos-riscv implements SD card driver, tty driver, interrupt handling, address translation, process scheduling and communication, system calls, file system, shell and 7 shell commands.",
